...
//          OutputStream.class("asdasdasd");
	...
	public String WBC() {
		if (Integer.parseInt(Window2.WBCtxt.getText())>=4500&&Integer.parseInt(Window2.WBCtxt.getText())<=11000 && Integer.parseInt(Window1.cardnumtxt.getText())>=18)
			return "WBC is proper!\n\n";
			 ...
			 return "WBC: Infection, if there is a fever,high values indicate blood disease or cancer\n Dedicated antibiotics,A combination of cyclophosphamide and corticosteroids,Entrectinib\n\n";
	...
	public String HCT() {
		...
		if(Integer.parseInt(Window2.HCTtxt.getText())<37 &&Window1.gendertxt.getSelectedItem()=="male")
			...
			return "HCT: Common in smokers so \n to stop smoking\n\n";
	...
	public String Urea() {
		...
		if(Integer.parseInt(Window2.Ureatxt.getText())>43 &&Window2.Orientaltxt.getSelectedItem()=="no")
			...
			return "Urea: Malnutrition, low-protein diet or liver disease  if she pregnant During pregnancy the level of urination decreases\n Schedule an appointment with a nutritionist,Schedule an appointment with a nutritionist,Referral to a specific diagnosis for the purpose of determining treatment \n\n";
			
			
		else if (Integer.parseInt(Window2.Ureatxt.getText())<18.7 &&Window2.Orientaltxt.getSelectedItem()=="yes")
			return "Urea: Malnutrition, low-protein diet or liver disease \n Schedule an appointment with a nutritionist,Schedule an appointment with a nutritionist,Referral to a specific diagnosis for the purpose of determining treatment \n\n";
	...
	public String Creatinine() {
		...
		if(Float.parseFloat(Window2.Creatininetxt.getText())>0.5&&Float.parseFloat(Window1.cardnumtxt.getText())<=2)
			return "Creatinine: Kidney problem, kidney failure. Diarrhea and vomiting cause increased muscle breakdown and high levels of creatinine, muscle diseases ,increased consumption of meat\n Balance blood sugar levels,Two 5 mg pills of Altman c3 turmeric a day for a month,Schedule an appointment with a nutritionist\n\n";
		
		else if(Float.parseFloat(Window2.Creatininetxt.getText())>1&&Float.parseFloat(Window1.cardnumtxt.getText())>=3 &&Float.parseFloat(Window1.cardnumtxt.getText())<=17)
			return "Creatinine: Kidney problem, kidney failure. Diarrhea and vomiting cause increased muscle breakdown and high levels of creatinine, muscle diseases ,increased consumption of meat\nBalance blood sugar levels,Two 5 mg pills of Altman c3 turmeric a day for a month,Schedule an appointment with a nutritionist\n\n";
		
		else if(Float.parseFloat(Window2.Creatininetxt.getText())>1&&Float.parseFloat(Window1.cardnumtxt.getText())>=18 &&Float.parseFloat(Window1.cardnumtxt.getText())<=59)
			return "Creatinine: Kidney problem, kidney failure. Diarrhea and vomiting cause increased muscle breakdown and high levels of creatinine, muscle diseases ,increased consumption of meat\n Balance blood sugar levels,Two 5 mg pills of Altman c3 turmeric a day for a month,Schedule an appointment with a nutritionist\n\n";
		
		else if(Float.parseFloat(Window2.Creatininetxt.getText())>1.2&&Float.parseFloat(Window1.cardnumtxt.getText())>=60)
			return "Creatinine: Kidney problem, kidney failure. Diarrhea and vomiting cause increased muscle breakdown and high levels of creatinine, muscle diseases ,increased consumption of meat\nBalance blood sugar levels,Two 5 mg pills of Altman c3 turmeric a day for a month,Schedule an appointment with a nutritionist\n\n";
		 else if (Float.parseFloat(Window2.Creatininetxt.getText())<0.2&&Float.parseFloat(Window1.cardnumtxt.getText())<=2)
			 return "Creatinine: In patients with very poor muscle mass and malnourished people who do not consume enough protein\n Two 5 mg pills of Altman c3 turmeric a day for a month,Schedule an appointment with a nutritionist\n\n";
		 else if(Float.parseFloat(Window2.Creatininetxt.getText())<0.5&&Float.parseFloat(Window1.cardnumtxt.getText())>=3 &&Float.parseFloat(Window1.cardnumtxt.getText())<=17)
			 return "Creatinine: In patients with very poor muscle mass and malnourished people who do not consume enough protein\n Two 5 mg pills of Altman c3 turmeric a day for a month,Schedule an appointment with a nutritionist\n\n";
		 else if(Float.parseFloat(Window2.Creatininetxt.getText())<0.6&&Float.parseFloat(Window1.cardnumtxt.getText())>=18 &&Float.parseFloat(Window1.cardnumtxt.getText())<=59)
			 return "Creatinine: In patients with very poor muscle mass and malnourished people who do not consume enough protein\n Two 5 mg pills of Altman c3 turmeric a day for a month,Schedule an appointment with a nutritionist\n\n";
		
		 else if(Float.parseFloat(Window2.Creatininetxt.getText())<0.6&&Float.parseFloat(Window1.cardnumtxt.getText())>=60)
			 return "Creatinine: In patients with very poor muscle mass and malnourished people who do not consume enough protein\n Two 5 mg pills of Altman c3 turmeric a day for a month,Schedule an appointment with a nutritionist\n\n";
		 else if(Float.parseFloat(Window2.Creatininetxt.getText())>=0.2&&Float.parseFloat(Window2.Creatininetxt.getText())<=0.5 &&Float.parseFloat(Window1.cardnumtxt.getText())<=2)
			 return "Creatinine is proper\n\n";
			 
		 else if(Float.parseFloat(Window2.Creatininetxt.getText())>=0.5&&Float.parseFloat(Window2.Creatininetxt.getText())<=1 &&Float.parseFloat(Window1.cardnumtxt.getText())>=3&&Float.parseFloat(Window1.cardnumtxt.getText())<=17)
			 return "Creatinine is proper\n\n";
		 else if(Float.parseFloat(Window2.Creatininetxt.getText())>=0.6&&Float.parseFloat(Window2.Creatininetxt.getText())<=1 &&Float.parseFloat(Window1.cardnumtxt.getText())>=18&&Float.parseFloat(Window1.cardnumtxt.getText())<=59)
			 return "Creatinine is proper\n\n";
		 else if(Float.parseFloat(Window2.Creatininetxt.getText())>=0.6&&Float.parseFloat(Window2.Creatininetxt.getText())<=1.2 &&Float.parseFloat(Window1.cardnumtxt.getText())>=60)
			 return "Creatinine is proper\n\n";
		return "";
	}
	...
	public String HDL() {
		...
		if(Integer.parseInt(Window2.HDLtxt.getText())>74.4 &&Window1.gendertxt.getSelectedItem()=="male"&&Window2.Ethiopianstxt.getSelectedItem()=="yes")
			return "HDL: Are usually harmless. Exercise raises good cholesterol levels\n Doing sport ";
			...
			return "HDLRisk of heart disease, on hyperlipidemia, diabetes in adults\n Schedule an appointment with a nutritionist,Schedule an appointment with a nutritionist, a 5 mg pill of Simobil daily for a week,Insulin adjustment for the patient\n\n";
	...
	public String Phosphatase() {
		...
		if (Integer.parseInt(Window2.Phosphatasetxt.getText())>120&&Window2.Orientaltxt.getSelectedItem()=="yes")
			...
			return "Phosphatase: On poor nutrition that lacks protein. Deficiency in vitamins like vitamin, vitamin B12,Vitamin B6 folic acid\n Schedule an appointment with a nutritionist,Referral for a blood test to identify the missing vitamins\n\n";
